...
/obj/machinery/chem_master
	...
	desc = "Используется для разделения и упаковки химикатов в пластыри, таблетки или бутылки. Гарантия недействительна при использовании для создания космических препаратов."
	density = 1
	anchored = 1
